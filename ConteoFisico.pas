...
var
  frmConteoFisico: TfrmConteoFisico;
  iType:SmallInt;
...
procedure TfrmConteoFisico.FormCreate(Sender: TObject);
var tFile:String;
begin
...
procedure TfrmConteoFisico.FormClose(Sender: TObject;
...
procedure TfrmConteoFisico.tbtSalirClick(Sender: TObject);
begin
    close;
end;

procedure TfrmConteoFisico.LoadXLS;
...
procedure TfrmConteoFisico.tbtVerClick(Sender: TObject);
begin
    pgcSincro.Visible := tbtVer.Checked;
end;

procedure TfrmConteoFisico.Preferencias1Click(Sender: TObject);
var iRes :Integer;
begin
...
procedure TfrmConteoFisico.LeerArticulos;
var i:Integer;
...
procedure TfrmConteoFisico.GrabarArticulos;
...
procedure TfrmConteoFisico.EliminarArticulos;
var i,iCount:Integer;
...
procedure TfrmConteoFisico.tbtLeerClick(Sender: TObject);
begin
    LeerArticulos;
end;

procedure TfrmConteoFisico.F1StartEdit(Sender: TObject;
...
procedure TfrmConteoFisico.F1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    case Key of
    VK_DELETE:
...
procedure TfrmConteoFisico.F1EndEdit(Sender: TObject;
  var EditString: WideString; var Cancel: Smallint);
begin
    MarkRows(UPD);
...
procedure TfrmConteoFisico.MarkRows(piAction:Integer);
var i:Integer;
begin
...
procedure TfrmConteoFisico.tbtMarcarUpdClick(Sender: TObject);
begin
    MarkRows(UPD);

end;

procedure TfrmConteoFisico.tbtMarcarDelClick(Sender: TObject);
begin
    MarkRows(DEL);

end;

procedure TfrmConteoFisico.tbtActualizarClick(Sender: TObject);
begin
...
procedure TfrmConteoFisico.xsbCopiarClick(Sender: TObject);
begin
    CopiarAbajo;
end;
procedure TfrmConteoFisico.CambiarPrecios;
...
procedure TfrmConteoFisico.CopiarAbajo;
...
procedure TfrmConteoFisico.tbtCreateClick(Sender: TObject);
begin
  axnLimpiar;
end;

procedure TfrmConteoFisico.tbtAbrirClick(Sender: TObject);
begin
    axnLeer;
end;

procedure TfrmConteoFisico.tbtGrabarClick(Sender: TObject);
begin
    axnGrabar;
end;

procedure TfrmConteoFisico.tbtPreverClick(Sender: TObject);
begin
    axnPrever;
end;

procedure TfrmConteoFisico.tbtImprimirClick(Sender: TObject);
begin
    axnImprimir;
end;

procedure TfrmConteoFisico.axnLimpiar;
begin
...
procedure TfrmConteoFisico.axnLeer;
var    tBuffer:WideString;
begin

        try
            F1.OpenFileDlg('Abrir archivo Articulos',frmConteoFisico.Handle,tBuffer);
        except
            tBuffer := '';
        end;
//    tFile := 'Doc.xls';
...
procedure TfrmConteoFisico.axnGrabar;
...
procedure TfrmConteoFisico.axnPrever;
begin
    try
        F1.FilePrintPreview;
    except
...
procedure TfrmConteoFisico.axnImprimir;
begin
    try
        F1.FilePrint(True);
    except
...
procedure TfrmConteoFisico.axnSort;
...
procedure TfrmConteoFisico.xsbSortClick(Sender: TObject);
begin
    axnSort;
end;

procedure TfrmConteoFisico.tbtAfectarClick(Sender: TObject);
begin
...
procedure TfrmConteoFisico.OcultarColumnas;
var fVacia:Boolean;
...
function TfrmConteoFisico.IsEmptyColumn(piCol:Integer):Boolean;
...
procedure TfrmConteoFisico.itmPLClick(Sender: TObject);
begin
  AsignarPL;
end;

procedure TfrmConteoFisico.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    case Key of
    VK_DELETE:
...
procedure TfrmConteoFisico.fraProducto1xceCodProdSerChange(Sender: TObject);
begin
...
procedure TfrmConteoFisico.xsbPreciosClick(Sender: TObject);
begin
    CambiarPrecios;
end;

procedure TfrmConteoFisico.tbtEliminarClick(Sender: TObject);
begin
    EliminarArticulos;
end;

procedure TfrmConteoFisico.tbtFontsClick(Sender: TObject);
begin
        F1.FormatFontDlg;
end;

procedure TfrmConteoFisico.AsignarPL;
