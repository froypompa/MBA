object frmProveedores: TfrmProveedores
  ...
  Caption = 'Proveedores - Actualizaci'#243'n'
  ClientHeight = 472
  ClientWidth = 699
  Color = clBtnFace
  ...
  object pgcMain: TPageControl
    ...
    object tshOtros: TTabSheet
      ...
      object grpTablas: TGroupBox
        ...
        object iedMoneda: TIB_Edit
          Left = 93
          Top = 85
          Width = 60
          Height = 21
          DataField = 'MONEDAPROV'
          DataSource = idsCtas
          Color = clMoneyGreen
          TabOrder = 3
          ButtonStyle = ebsEllipsis
          AlwaysShowButton = True
          OnButtonClick = iedMonedaButtonClick
          OnChange = iedMonedaChange
        end
        object xceDescMoneda: TComboEdit
          Left = 158
          Top = 83
          Width = 228
          Height = 21
          ...
          NumGlyphs = 1
          TabOrder = 4
          OnButtonClick = xceDescMonedaButtonClick
        end
      end
  ...
  object iqrCtas: TIB_Query
    ...
    OrderingItems.Strings = (
      ...
      'NOMBPROVEE=NOMBPROVEE;NOMBPROVEE DESC')
