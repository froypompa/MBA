...
type
  TfrmControlTarimas = class(TForm)
    dckSincro: TTBXDock;
    tlbMain: TTBXToolbar;
    tbtSalir: TTBXItem;
    ...
    procedure btnListarProdClick(Sender: TObject);
...
var
  frmControlTarimas: TfrmControlTarimas;
  iType:SmallInt;
...
procedure TfrmControlTarimas.FormCreate(Sender: TObject);
var tFile:String;
begin
...
procedure TfrmControlTarimas.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
    FreeAndNil(oF1);
//    FreeAndNil(frmClienteAct);
    frmControlTarimas := nil;
    Action := caFree;
end;

procedure TfrmControlTarimas.PrepareSQL;
var
  i:Integer;
  td,tnum:String;
  EsCodigo:Boolean;
begin
  ...
  with icuRep do begin
    ...
    if rbtDescripcion.Checked then
...
procedure TfrmControlTarimas.FormActivate(Sender: TObject);
begin
  pgcSincro.ActivePageIndex := 0;
  CalculaFechas;
end;

procedure TfrmControlTarimas.tbtSalirClick(Sender: TObject);
begin
    close;
end;

procedure TfrmControlTarimas.SetUp;
begin
  rC1.CodcteProv := 2;
  rC1.Numero     := 3;
  rC1.RazSocial  := 4;
...
procedure TfrmControlTarimas.clzDocChange(Sender: TObject; Index: Integer;
  NewState: TCheckBoxState);
begin
  UpdateControls;
end;

procedure TfrmControlTarimas.edzCodigoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case Key of
    VK_RETURN:
      begin
        btnListarProdClick(nil); //	Delete key
      end;
  else
  end;
...
procedure TfrmControlTarimas.LoadXLS;
var
  i:Integer;
  tFile,tDir:String;
begin
...
procedure TfrmControlTarimas.UpdateControls;
Var
  i,iSel:Integer;
  fSel:Boolean;
begin
...
procedure TfrmControlTarimas.ListarProductos;
var
...
begin
  ...
  begin
    ...
    while not Eof do
    begin
      F1.EntrySRC[iSheet, iRow, 2] := FieldByName('CODPRODSER').AsString;
      F1.EntrySRC[iSheet, iRow, 3] := FieldByName('DescripPro').AsString;
      F1.EntrySRC[iSheet, iRow, 4] := '';
      F1.EntrySRC[iSheet, iRow, 5] := FieldByName('ExisTotal').AsString;
      F1.EntrySRC[iSheet, iRow, 6] := FieldByName('PcioVta1').AsString;
      F1.EntrySRC[iSheet, iRow, 7] := FieldByName('PcioVta2').AsString;
      F1.EntrySRC[iSheet, iRow, 8] := FieldByName('PcioVta3').AsString;
      F1.EntrySRC[iSheet, iRow, 10] := FieldByName('PathFoto').AsString;
      tDescripTec := FieldByName('DescripTec').AsString;
      tDescripTec := trim(tDescripTec);
      F1.TExtSRC[iSheet, iRow, 12] := copy(tDescripTec, 1, 250);
      F1.TExtSRC[iSheet, iRow, 13] := copy(tDescripTec, 251, 250);

      iRow := iRow + 1;
      Next;
    end;
    F1.SetSelection(1, 1, iRow, Fields.ColumnCount + 1);
...
procedure TfrmControlTarimas.GenerarReporte;
...
procedure TfrmControlTarimas.ListarDocs;
var i,iCount:Integer;
    iSheet,iRec,Row,iEsquema:Integer;
...
procedure TfrmControlTarimas.ListarDetalle;
var
...
procedure TfrmControlTarimas.Resaltar1(ARen,ATipo:Integer);
var
  iSht:Integer;
  tS:String;
begin
...
procedure TfrmControlTarimas.btnActDescuentosClick(Sender: TObject);
var
  mr:Integer;
begin
...
procedure TfrmControlTarimas.F1SelChange(Sender: TObject);
begin
...
procedure TfrmControlTarimas.F1StartEdit(Sender: TObject;
...
procedure TfrmControlTarimas.F1DblClick(ASender: TObject; nRow, nCol: Integer);
begin
...
procedure TfrmControlTarimas.F1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    case Key of
    VK_DELETE:
...
procedure TfrmControlTarimas.tbtCreateClick(Sender: TObject);
begin
  axnLimpiar;
end;

procedure TfrmControlTarimas.tbtGenerarClick(Sender: TObject);
begin
    GenerarReporte;
end;

procedure TfrmControlTarimas.tbtGrabarClick(Sender: TObject);
begin
    axnGrabar;
end;

procedure TfrmControlTarimas.tbtPreverClick(Sender: TObject);
begin
    axnPrever;
end;

procedure TfrmControlTarimas.tbtImprimirClick(Sender: TObject);
begin
    axnImprimir;
end;

procedure TfrmControlTarimas.tbtModificarClick(Sender: TObject);
begin
  Cliente_Update;
end;

procedure TfrmControlTarimas.axnLimpiar;
begin
...
procedure TfrmControlTarimas.axnLeer;
var    tBuffer:WideString;
begin

        try
            F1.OpenFileDlg('Abrir archivo Articulos',frmControlTarimas.Handle,tBuffer);
        except
            tBuffer := '';
        end;
//    tFile := 'Doc.xls';
...
procedure TfrmControlTarimas.axnGrabar;
...
procedure TfrmControlTarimas.axnPrever;
begin
    SetPrintSelection;
    try
        F1.FilePrintPreview;
...
procedure TfrmControlTarimas.btnDetClick(Sender: TObject);
begin
  ListarDetalle;
end;

procedure TfrmControlTarimas.btnDocsClick(Sender: TObject);
begin
  ListarDocs;
end;

procedure TfrmControlTarimas.btnLast20Click(Sender: TObject);
begin
  mfLast20 := True;
  GenerarReporte;
...
procedure TfrmControlTarimas.btnListarProdClick(Sender: TObject);
begin
  mfLast20 := False;
  GenerarReporte;
end;

procedure TfrmControlTarimas.btnSortClick(Sender: TObject);
begin
  axnSort;
end;

procedure TfrmControlTarimas.axnImprimir;
begin
...
procedure TfrmControlTarimas.SetPrintSelection;
var
  iSh: Integer;
  tSel:String;
begin
...
procedure TfrmControlTarimas.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
    case Key of
    VK_DELETE:
...
procedure TfrmControlTarimas.FormShow(Sender: TObject);
begin
      MainForm.AplicarPerfil2(self);

end;

procedure TfrmControlTarimas.itmAyudaClick(Sender: TObject);
begin
  ShowHelp('frmClientes2');
end;

procedure TfrmControlTarimas.itmBuscarClick(Sender: TObject);
begin
  F1.FindDlg;
end;

procedure TfrmControlTarimas.itmFijarClick(Sender: TObject);
begin
  axnFixRows(miRowIni-1);
end;

procedure TfrmControlTarimas.itmLiberarClick(Sender: TObject);
begin
  axnFixRows(0);
end;

procedure TfrmControlTarimas.axnFixRows(ARows:Integer);
var
  i,iT,iSh:Integer;
begin
  iSh := F1.Sheet;
...
procedure TfrmControlTarimas.axnFiltrarVendedores(AShow:Boolean);
var
  i,iT,iSh:Integer;
  tNum,t:String;
begin
...
procedure TfrmControlTarimas.axnSort;
var
...
--------------------------------------------------------------------------------}
procedure TfrmControlTarimas.tbtNuevoClick(Sender: TObject);
begin
  Cliente_Insert;
end;

procedure TfrmControlTarimas.Cliente_Insert;
begin
...
procedure TfrmControlTarimas.Cliente_Update;
var
  tCod:String;
begin
  if frmClienteAct = nil then
...
procedure TfrmControlTarimas.Cliente_Delete;
var
  tCod:String;
begin
  if frmClienteAct = nil then
