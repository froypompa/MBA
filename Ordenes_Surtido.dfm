object frmOrdenes_Surtido: TfrmOrdenes_Surtido
  Left = 223
  Top = 113
  BorderIcons = [biSystemMenu, biMinimize, biMaximize, biHelp]
  Caption = 'Almacen: Control de Ordenes de Surtido'
  ClientHeight = 648
  ClientWidth = 1192
  Color = clBtnFace
  ...
  object Dock971: TTBXDock
    ...
    object tlbMain: TTBXToolbar
      ...
      object tbtListar: TTBXItem
        ...
        Hint = 'Listar los pedidos pendientes de Entregar'
        ImageIndex = 16
        Options = [tboImageAboveCaption]
        OnClick = tbtListarClick
      end
      object tbtListarTodos: TTBXItem
        Caption = ' &Listar Todos [F4]'
        DisplayMode = nbdmImageAndText
        Hint = 'Listas Pedidos, incluidos los entregados'
        ImageIndex = 16
        Options = [tboImageAboveCaption]
        OnClick = tbtListarTodosClick
      end
      ...
      object tbtAsignar: TTBXItem
        Caption = '&Asignar [F5]'
        DisplayMode = nbdmImageAndText
        Hint = 'Asignar Pedido a Surtidor'
        ImageIndex = 61
        Options = [tboImageAboveCaption]
        ShortCut = 116
      ...
      object tbtSurtido: TTBXItem
        Caption = '&Grabar Surtido [F7]'
        DisplayMode = nbdmImageAndText
        Hint = 'Grabar las cantidades surtidas'
        ImageIndex = 80
        Options = [tboImageAboveCaption]
        ShortCut = 118
        OnClick = tbtSurtidoClick
        Left = 133
      end
      object tbtEntregado: TTBXItem
        Caption = '&Entregado!! [F8]'
        DisplayMode = nbdmImageAndText
        Hint = 'Marcar el pedido como entregado a Embarques'
        ImageIndex = 40
        Options = [tboImageAboveCaption]
        ShortCut = 119
        OnClick = tbtEntregadoClick
        Left = 133
      end
      object TBXSeparatorItem2: TTBXSeparatorItem
      end
      object tbtGrabarComentarios: TTBXItem
        Caption = '&Grabar Comentarios'
        DisplayMode = nbdmImageAndText
        Hint = 'Grabar los comentarios capturados'
        ImageIndex = 24
        Options = [tboImageAboveCaption]
        ShortCut = 118
        OnClick = tbtGrabarComentariosClick
        Left = 133
      end
      ...
      object tbtCerrar: TTBXItem
        ...
        DisplayMode = nbdmImageAndText
        Hint = 'Cerrar pedido y quitarlo de la lista'
        ImageIndex = 98
        Options = [tboImageAboveCaption]
        ShortCut = 118
      ...
      object TBXSubmenuItem1: TTBXSubmenuItem
        ...
        object tbtNumPed: TTBXItem
          Tag = 1
          Caption = 'Pedidos: Numero Pedido'
          ImageIndex = 171
          Images = MainForm.ImageList1
          OnClick = tbtNumPedClick
        end
        ...
        object tbtSortPartidas10: TTBXItem
          Tag = 10
          Caption = 'Partidas: Numero Partida'
          ImageIndex = 171
          Images = MainForm.ImageList1
          OnClick = tbtSortPartidas10Click
        end
      ...
      object TBXSubmenuItem2: TTBXSubmenuItem
        Caption = '  &Buscar  '
        DisplayMode = nbdmImageAndText
        Hint = 'Buscr texto en los listados'
        ImageIndex = 65
        Options = [tboDropdownArrow, tboImageAboveCaption]
  ...
  object RzSplitter1: TRzSplitter
    ...
    object pgcMain: TRzPageControl
      ...
      object tshListado: TRzTabSheet
        ...
        object RzSplitter2: TRzSplitter
          ...
          object F1: TF1Book
            ...
            ExplicitHeight = 171
            ControlData = {
              00000100396000007F15000060000000010001074631426F6F6B310101010101
              0101010101010101010101006905000000000900050500EE0400000000EF1400
              0000FF0000FF3F0400FFFFFFFFFFFFFFFFF3FF3D12000000008D36300C380000
          ...
          object F2: TF1Book
            ...
            ExplicitHeight = 163
            ControlData = {
              
      ...
      object tshImpresion: TRzTabSheet
        ...
        object F11: TF1Book
          ...
          ExplicitHeight = 345
          ControlData = {
            
    ...
    object pgcAcciones: TRzPageControl
      Left = 0
      Top = 0
      Width = 246
      Height = 453
      ...
      object TabSheet3: TRzTabSheet
        Caption = 'Acciones'
        object btnCompleto1: TRzBitBtn
          Left = 0
          Top = 0
          Width = 242
          Height = 42
          Align = alTop
          Caption = 'Capturar y Grabar COMPLETO!!'
          HotTrack = True
          TabOrder = 0
          OnClick = btnCompleto1Click
          ImageIndex = 2
          Images = ImageList1
        end
        object btnCompletoMod: TRzBitBtn
          Left = 0
          Top = 42
          Width = 242
          Height = 42
          Align = alTop
          Caption = 'Poner Surtida = Pedida'
          HotTrack = True
          TabOrder = 1
          OnClick = btnCompletoModClick
          ImageIndex = 3
          Images = ImageList1
        end
        object btnImprimirCopia: TRzBitBtn
          Left = 0
          Top = 84
          Width = 242
          Height = 42
          Align = alTop
          Caption = 'Imprimir Copia de OS'
          HotTrack = True
          TabOrder = 2
          OnClick = btnImprimirCopiaClick
          ImageIndex = 4
          Images = ImageList1
        end
      end
  ...
  object ImageList1: TImageList
    ...
    Bitmap = {
      ...
      
