...
type
  TfrmOrdenes_Surtido = class(TForm)
    ...
    btnCompleto1: TRzBitBtn;
    btnCompletoMod: TRzBitBtn;
    btnImprimirCopia: TRzBitBtn;
    RzGroupBox2: TRzGroupBox;
    chkDialogoImpre: TRzCheckBox;
    tbtGrabarComentarios: TTBXItem;
    TabSheet2: TRzTabSheet;
    tbtListarTodos: TTBXItem;
    ...
    procedure LoadF2;
    procedure LoadF11;
    procedure PrepareSQL(AOpcion:SmallInt = 0);
    ...
    procedure tbtSurtidoClick(Sender: TObject);
    ...
    procedure tbtListarTodosClick(Sender: TObject);
    ...
    procedure tbtGrabarComentariosClick(Sender: TObject);
    procedure tbtCerrarClick(Sender: TObject);
    procedure tbtNumPedClick(Sender: TObject);
    procedure tbtSortPartidas10Click(Sender: TObject);
...
var
  frmOrdenes_Surtido: TfrmOrdenes_Surtido;
  iType:SmallInt;
...
procedure TfrmOrdenes_Surtido.FormCreate(Sender: TObject);
begin
...
procedure TfrmOrdenes_Surtido.FormShow(Sender: TObject);
begin
...
procedure TfrmOrdenes_Surtido.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
    frmOrdenes_Surtido := nil;
    FreeandNil(oOS);
    FreeandNil(oDE);
...
procedure TfrmOrdenes_Surtido.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  case Key of
    //    VK_ESCAPE: Crear;
    VK_F3: tbtListarClick(Sender);
    VK_F4: tbtListarTodosClick(Sender);
    VK_F5: tbtAsignarClick(Sender);
    VK_F6: tbtImprimirClick(Sender);
    VK_F7: tbtSurtidoClick(Sender);
...
procedure TfrmOrdenes_Surtido.tbtAsignarClick(Sender: TObject);
begin
  AsignarSurtidor;
end;

procedure TfrmOrdenes_Surtido.tbtAutoListarClick(Sender: TObject);
begin
...
procedure TfrmOrdenes_Surtido.tbtCerrarClick(Sender: TObject);
var
  mr:Integer;
begin
  Apagar_AutoListado;
...
//  mr := MessageBox(0, 'La Orden se cerrará y ya NO aparecerá en los listados.'+#13+#10+'Deseas Continuar??', 'MBA - Almacén - Cerrar Orden de Surtido', MB_ICONWARNING or MB_YESNO);

  if mr = mrOk then
    Grabar_Cerrado;
end;

procedure TfrmOrdenes_Surtido.tbtEntregadoClick(Sender: TObject);
begin
  Grabar_Entregado;
end;

procedure TfrmOrdenes_Surtido.tbtFindF1Click(Sender: TObject);
begin
  F1.FindDlg;
end;

procedure TfrmOrdenes_Surtido.tbtFindF2Click(Sender: TObject);
begin
  F2.FindDlg;
end;

procedure TfrmOrdenes_Surtido.tbtGrabarComentariosClick(Sender: TObject);
begin
  Apagar_AutoListado;
  Grabar_Comentarios;
end;

procedure TfrmOrdenes_Surtido.tbtImprimirClick(Sender: TObject);
begin
  Imprimir;
  UpdateControls;
end;

procedure TfrmOrdenes_Surtido.tbtListarClick(Sender: TObject);
begin
  PrepareSQL(0);
  ListarPedidos;
end;

procedure TfrmOrdenes_Surtido.tbtListarTodosClick(Sender: TObject);
begin
  PrepareSQL(1);
  ListarPedidos;
end;

procedure TfrmOrdenes_Surtido.tbtNumPedClick(Sender: TObject);
begin
  Apagar_AutoListado;
  SortPedidos((Sender as TTBXItem).Tag);
end;

procedure TfrmOrdenes_Surtido.tbtOpcionesClick(Sender: TObject);
begin
  pgcOpciones.Visible := not pgcOpciones.Visible;
end;
procedure TfrmOrdenes_Surtido.tbtSalirClick(Sender: TObject);
begin
  Close;
end;
procedure TfrmOrdenes_Surtido.tbtSortPartidas10Click(Sender: TObject);
begin
  Apagar_AutoListado;
...
procedure TfrmOrdenes_Surtido.tbtSurtidoClick(Sender: TObject);
begin
  Grabar_Surtido;
end;
...
//Eventos F1 y F2
procedure TfrmOrdenes_Surtido.F1Click(ASender: TObject; nRow, nCol: Integer);
begin
  ListarDetalle;
  UpdateControls;
end;

procedure TfrmOrdenes_Surtido.F1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmOrdenes_Surtido.F1SelChange(Sender: TObject);
begin
  Llena_Comentarios;
end;

procedure TfrmOrdenes_Surtido.F2Enter(Sender: TObject);
begin
  Apagar_AutoListado;
end;


procedure TfrmOrdenes_Surtido.F2SelChange(Sender: TObject);
begin
  Llena_Comentarios;
end;

procedure TfrmOrdenes_Surtido.TBXItem4Click(Sender: TObject);
begin
  ShowHelp('frmOrdenes_Surtido');
end;

procedure TfrmOrdenes_Surtido.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmOrdenes_Surtido.btnCompleto1Click(Sender: TObject);
begin
  Captura_Surtida;
  Grabar_Surtido;
end;

procedure TfrmOrdenes_Surtido.btnCompletoModClick(Sender: TObject);
begin
  Captura_Surtida;
end;

procedure TfrmOrdenes_Surtido.btnImprimirCopiaClick(Sender: TObject);
begin
  LlenaOrden;
  F11.FilePrint(chkDialogoImpre.Checked);
end;

procedure TfrmOrdenes_Surtido.mmzPartidaAlmacenChange(Sender: TObject);
begin
  F2.TextSRC[1,F2.Row,rC2.ComAlmacenD] := mmzPartidaAlmacen.Text;
end;

procedure TfrmOrdenes_Surtido.mmzPartidaVentasChange(Sender: TObject);
begin
  F2.TextSRC[1,F2.Row,rC2.ComVentasD] := mmzPartidaVentas.Text;
end;

procedure TfrmOrdenes_Surtido.mmzPedidoAlmacenChange(Sender: TObject);
begin
  F1.TextSRC[1,F1.Row,rC1.ComAlmacenP] := mmzPedidoAlmacen.Text;
end;

procedure TfrmOrdenes_Surtido.mmzPedidoCxCChange(Sender: TObject);
begin
  F1.TextSRC[1,F1.Row,rC1.ComCxC] := mmzPedidoCxC.Text;
end;

procedure TfrmOrdenes_Surtido.mmzPedidoVentasChange(Sender: TObject);
begin
  F1.TextSRC[1,F1.Row,rC1.ComVentasP] := mmzPedidoVentas.Text;
end;

procedure TfrmOrdenes_Surtido.mmzPedidoVentasEnter(Sender: TObject);
begin
  Apagar_AutoListado;
end;

procedure TfrmOrdenes_Surtido.pgcMainChange(Sender: TObject);
begin
...
procedure TfrmOrdenes_Surtido.SetUp;
begin
  rC1.OS           := 2;
  rC1.FH_Recibido  := 3;
  rC1.Surtidor     := 4;
...
procedure TfrmOrdenes_Surtido.LoadF1;
var
  i:Integer;
  tFile,tDir:String;
begin
...
procedure TfrmOrdenes_Surtido.LoadF2;
var
  i:Integer;
  tFile,tDir:String;
begin
...
procedure TfrmOrdenes_Surtido.LoadF11;
var
  i:Integer;
  tFile,tDir:String;
begin
...
procedure TfrmOrdenes_Surtido.PrepareSQL(AOpcion:SmallInt = 0);
var
  i:Integer;
  td,tnum:String;
  EsCodigo:Boolean;
begin
  ...
  if AOpcion = 0 then  //Pendientes...
    with icuPed do begin
      ...
      SqL.Add ('      (a.liberado >= 1) and (cerrado <=0) and (cancelado <=0) ');
...
procedure TfrmOrdenes_Surtido.ListarPedidos;
var
  tStr, tCod, tDes, tNumAlmacen,tTiempo: string;
  iSheet, iRow, iCol, iTopRow, iLeftCol, iField, iPos, iCount, Row: Integer;
...
//  F1.SetFocus;
  ...
  while not icuPed.Eof do begin
      ...
      F1.TextSRC[iSheet,Row,rC1.OS]              := icuPed.fieldbyName('ORDEN').AsString;
      F1.NumberSRC[iSheet,Row,rC1.FH_Recibido]   := icuPed.fieldbyName('FH_RECIBIDO').AsDateTime;
...
procedure TfrmOrdenes_Surtido.ListarDetalle;
var
...
procedure TfrmOrdenes_Surtido.Captura_Surtida;
var
  tCodPS: string;
  iRen : Integer;
begin
...
procedure TfrmOrdenes_Surtido.Grabar_Entregado;
var
  v:Variant;
begin
...
procedure TfrmOrdenes_Surtido.Grabar_Cerrado;
var
  v:Variant;
begin
  ...
  if oOS.Error = 0 then begin
    sbMsg1.Caption := 'La Orden se cerró correctamente!!';
  end else begin
     MessageDlg('La Orden de Surtido NO se puede cerrar hasta terminarla completamente!!', mtError, [mbOK], 0);
  end;
  ListarPedidos;
  UpdateControls;
end;

procedure TfrmOrdenes_Surtido.Grabar_Surtido;
var
  v:Variant;
begin
...
procedure TfrmOrdenes_Surtido.Grabar_Cantidad_Surtida;
var
  tCodPS : String;
  iRen,iPend:Integer;
  iSt,iStDet:SmallInt;
...
procedure TfrmOrdenes_Surtido.Llena_Comentarios;
begin
...
procedure TfrmOrdenes_Surtido.Grabar_Comentarios;
var
  tCodPS : String;
  iRen,iPend:Integer;
  iSt,iStDet:SmallInt;
...
procedure TfrmOrdenes_Surtido.Imprimir;
var
  v:Variant;
begin
...
procedure TfrmOrdenes_Surtido.LlenaOrden;
var
...
procedure TfrmOrdenes_Surtido.AsignarSurtidor;
var
...
procedure TfrmOrdenes_Surtido.Resaltar1(ARen,ATipo:Integer);
var
  iSht:Integer;
  tS:String;
begin
...
procedure TfrmOrdenes_Surtido.Resaltar2(ARen,ATipo:Integer);
var
  iSht:Integer;
  tS:String;
begin
...
procedure TfrmOrdenes_Surtido.SortPedidos(AOpcion:Integer);
var
...
procedure TfrmOrdenes_Surtido.SortPartidas(AOpcion:Integer);
var
  iIndex,iSheet,ix:Integer;
  iC1,iC2,iC3:Integer;
begin
...
procedure TfrmOrdenes_Surtido.UpdateControls;
Var
  i,iSel:Integer;
  fSel:Boolean;
  tSurtidor:String;
begin
  ...
  tbtSurtido.Enabled        := tbtImprimir.Enabled;
  tbtEntregado.Enabled      := tbtImprimir.Enabled;

  btnCompleto1.Enabled      := tbtImprimir.Enabled;
  btnCompletoMod.Enabled    := tbtImprimir.Enabled;
  btnImprimirCopia.Enabled  := tbtImprimir.Enabled;

end;

procedure TfrmOrdenes_Surtido.ShowHeadersF1(ATrueFalse:Boolean);
Var
  r:Integer;
begin
...
procedure TfrmOrdenes_Surtido.ShowHeadersF2(ATrueFalse:Boolean);
Var
  r:Integer;
begin
  for r := 1 to 3 do begin
...
procedure TfrmOrdenes_Surtido.Apagar_AutoListado;
begin
...
procedure TfrmOrdenes_Surtido.Encender_AutoListado;
begin
